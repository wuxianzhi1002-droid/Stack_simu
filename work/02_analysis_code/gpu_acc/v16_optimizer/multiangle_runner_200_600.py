...
VERSION='v16_stage3_user_pair_0p1_0p2_200_600_gpu';EXPECTED_V10='d0c5076deef971a3cce169220e37072fa8dd61a24f6a21401707f6150474b321'
BANDS={'200-600':(200.0,600.0)};MODES=('single_primary','joint_two_angle')
...
def load_group(path,start,stop):
 with np.load(path,allow_pickle=False) as d:
  ...
  if not np.allclose(true_angles,np.asarray([0.1,0.2]),rtol=0.0,atol=1e-12): raise ValueError(f'unexpected fixed pair {true_angles} in {path.name}')
