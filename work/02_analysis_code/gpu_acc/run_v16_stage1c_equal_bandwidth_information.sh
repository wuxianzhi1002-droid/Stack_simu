...
#SBATCH --job-name=v16_s1c_equal_info
#SBATCH --output=v16_s1c_equal_info_slurm_%j.out
#SBATCH --error=v16_s1c_equal_info_slurm_%j.err
set -Eeo pipefail
...
RUN_ROOT="${TMM_V16_RUN_ROOT:-/ssd/$USER/v16_stage1c_runs}"
...
print('[PASS] V16 Stage 1C input and calibration gates')
PY
...
python -m v16_optimizer.equal_bandwidth_information --input-dir "$INPUT_DIR" --noise-calibration-dir "$CALIBRATION_DIR" --output-dir "$RUN_DIR/results" --machine "$RUN_DIR/machine_info.json"
