...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--scenarios",
        nargs="+",
        choices=["clean", "uniform_pm_nm", "gaussian_sigma_nm", "gaussian_sigma_nm_clipped"],
        default=["gaussian_sigma_nm"],
        help=(
...
def make_output_dir() -> Path:
    ...
    output_dir = SCRIPT_DIR / f"residual_mlp_simple_pca_label_uncertainty_v3_{stamp}"
...
def scenario_label_noise(
    ...
    if scenario in {"uniform_pm_1nm", "uniform_pm_nm"}:
