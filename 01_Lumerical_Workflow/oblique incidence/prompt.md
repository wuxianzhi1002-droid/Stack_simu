...
项目已有背景：
1. 当前项目中已经有 01_Lumerical_Workflow/main_angle.py、main_cavity.py、solve_npz_fft.py 等脚本。
...
1. 01_Lumerical_Workflow/oblique incidence/main_grazing_stackrt.py
2. 01_Lumerical_Workflow/oblique incidence/solve_grazing_asd.py
3. 01_Lumerical_Workflow/oblique incidence/simulate_grazing_triangulation.py
4. 01_Lumerical_Workflow/oblique incidence/run_grazing_validation.py
5. 01_Lumerical_Workflow/oblique incidence/grazing_config.py
...
- 使用 typing 类型提示。
- 所有输出统一保存到：
  - 01_Lumerical_Workflow/oblique incidence//grazing/
  - 01_Lumerical_Workflow/oblique incidence/img/grazing/
  - 01_Lumerical_Workflow/oblique incidence/linear_fit/grazing/
- 所有 npz 文件名必须带时间戳。
- 所有图像必须保存 png。
...
python 01_Lumerical_Workflow/oblique incidence/solve_grazing_asd.py --input 最新的 grazing_stackrt npz
python 01_Lumerical_Workflow/oblique incidence/simulate_grazing_triangulation.py --input 最新的 grazing_asd npz
...
11. 写完后运行至少一次静态检查：
    python -m py_compile 01_Lumerical_Workflow/oblique incidence/grazing_config.py
    python -m py_compile 01_Lumerical_Workflow/oblique incidence/main_grazing_stackrt.py
    python -m py_compile 01_Lumerical_Workflow/oblique incidence/solve_grazing_asd.py
    python -m py_compile 01_Lumerical_Workflow/oblique incidence/simulate_grazing_triangulation.py
    python -m py_compile 01_Lumerical_Workflow/oblique incidence/run_grazing_validation.py
