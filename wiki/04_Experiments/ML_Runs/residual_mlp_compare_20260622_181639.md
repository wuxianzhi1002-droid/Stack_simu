...
2. 版本 1 scalar_baseline 的 test 误差是多少？
   ...
   MAE=13.221 nm, RMSE=16.880 nm, MaxAbs=65.472 nm, R2=0.97183

3. 版本 2 scalar_selected_quadratic 的 test 误差是多少？

   MAE=16.223 nm, RMSE=20.144 nm, MaxAbs=65.476 nm, R2=0.95988

4. 二阶特征是否改善了未见 process 的测试误差？

   否，selected_quadratic 的 test RMSE 没有低于 scalar_baseline。
...
7. 当前结果是否说明仅靠 scalar features 就能补偿 ±10 nm 膜厚扰动？
   ...
   当前结果说明 scalar features 有一定补偿能力，但还没有非常充分。如果目标是更低误差，后续需要考虑引入光谱 I(lambda) 或角度/偏振信息。

## Method Comparison

| method | test cavity_MAE_nm | test cavity_RMSE_nm | test cavity_MaxAbs_nm | R2_delta |
|---|---:|---:|---:|---:|
| raw_fft_baseline | 1052.351 | 1057.146 | 1280.172 | -109.48333 |
| mean_residual_baseline | 88.013 | 102.553 | 207.772 | -0.03974 |
| scalar_baseline | 13.221 | 16.880 | 65.472 | 0.97183 |
| scalar_selected_quadratic | 16.223 | 20.144 | 65.476 | 0.95988 |
